...
draw_ets_rank_test_plots <- function() {
  ...
  for (performance_criteria in levels(factor(ets_plot_df$PerformanceCriteria))) {
    temp_ets_plot_df <- ets_plot_df[ets_plot_df$PerformanceCriteria==performance_criteria, ]
    print(performance_criteria)
    print(str(temp_ets_plot_df))
    
    #CHECK!!!
    t_test <- t.test(data=temp_ets_plot_df, temp_ets_plot_df$DT, temp_ets_plot_df$ST, paired=T)
    print(t_test)
    
    #CHECK!!!
    w_test <- wilcoxon.test(data=temp_ets_plot_df, temp_ets_plot_df$DT, temp_ets_plot_df$ST, paired=T)
    print(w_test)
