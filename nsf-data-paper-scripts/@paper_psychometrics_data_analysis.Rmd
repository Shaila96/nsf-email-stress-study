...
modify_final_df <- function() {
  ...
  psychometric_df <<- merge(x=psychometric_df, y=mean_df, by.x="SubjectID", by.y="Subject", all.x=TRUE) %>%
    rename('Participant ID'=SubjectID,
           ...
           'Other Native Language'=Other_Native_Language,
           'Writing Proficiency'=Writing_Proficiency,
           'Daily Email Frequency'=Daily_Email_Frequency
           ) %>% 
    select('Participant ID', 
           ...
           'ERQ_Cognitive Reappraisal',
           'ERQ_Expressive Suppression',
           
           'PSS_Percieved Stress Scale',
           
           'NASA_Mental Demand',
           'NASA_Physical Demand',
           'NASA_Temporal Demand',
           NASA_Performance,
           NASA_Effort,
           NASA_Frustration)
