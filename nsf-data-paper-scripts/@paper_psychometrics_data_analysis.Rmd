...
draw_group_bar_chart_nasa_tlx <- function() {
  ...
  for (ques_sub_type in ques_sub_type_levels) {
    ...
    # sapply(seq(1, 4), function(x) add_color(nasa_color_code[1]))
    # sapply(seq(5, 7), function(x) add_color(nasa_color_code[2]))
    ...
    nasa_hist_plot <- temp_nasa_long_df %>%
      ...
      xlab(x_lab_hist) +
      ylab('Frequency') +
      # scale_fill_manual(values=c(rep(nasa_color_code[1], 4), rep(nasa_color_code[2], 3))) +
