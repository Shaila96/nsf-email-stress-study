...
extract_nasa_tlx_score <- function() {
  ...
  psychometric_df <<- merge(psychometric_df, nasa_tlx_df, by='SubjectID', all.x=T)
  # convert_to_csv(psychometric_df, file.path(final_data_dir, 'psychometric_data.csv'))
}
