...
col_names_final <- c("Subject", "Condition", "Session", "PP", "HR", "BR", "N.EDA", "N.HR", "HRV")
...
filtered_file_name <- file.path('data-from-tamu', 'v1', 'df_hrv.csv')
...
figure_out_labels <- function(col_name, test_type) { 
  ...
  } else if (isMatch(col_name, 'HRV')) {
    return(expression(Delta~bar('HRV')~' [IBI]')) 
  } 
  return('Unknown axis.') 
} 
