...
bio_ques_list <- c('City', 'State', 'Postal', 
                   ...
                   'Nationality', 'Other_Nationality', 'Native_Lang', 'Other_Native_Lang',
                   'Education', 'Occupation', 'Writing_Proficiency', 'Daily_Email_Frequency')

nasa_tlx_ques_list <- c('Stress_Ques', 'Nasa_Mental', 'Nasa_Physical', 'Nasa_Temporal',
...
draw_distribution <- function(col_name) {
  title <- paste0(col_name, ' Distribution')
  x_lab <- paste0(col_name, ' of Subjects')
  y_lab <- 'Frequency'
  
  plot <- ggplot(data=biographic_df, aes(biographic_df[[col_name]])) + 
...
get_biographic_distribution <- function() {
  ...
  # draw_education_distribution()
  # draw_nationality_distribution()
  # draw_native_lang_distribution()
  # draw_occupation_distribution()
  # draw_writing_proficiency_distribution()
  # draw_daily_email_freq_distribution()
}
``` 
