  ...
  if (session_name=='StressCondition') {
    for (condition_type in condition_types) {
      ...
      t_test_hr(mean_hr_df,
                paste0('HR Boxplot - ', get_session_title(session_name, condition_type)),
                paste0('hr_boxplot_', get_session_title(session_name, condition_type)))
    }
  } else {
    mean_hr_df <- mean_df[mean_df$Session==session_name, hr_col_list]
    t_test_hr(mean_hr_df, 
              paste0('HR Boxplot - ', get_session_title(session_name)), 
              paste0('hr_boxplot_', get_session_title(session_name)))
  }
}
